...
module "oci-arch-wordpress" {
  depends_on                = [oci_core_instance.MySQLinstance, oci_bastion_session.ssh_via_bastion_service, null_resource.MySQL_provisioner]
  ...
  wp_subnet_id              = oci_core_subnet.public.id
